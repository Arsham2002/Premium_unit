...
namespace PremiumUnit.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Amount,IssueDate,PaymentDate,PenaltyBaseDate")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Amount,IssueDate,PaymentDate,PenaltyBaseDate")] Invoice invoice)
        {
            if (id != invoice.Id)
            {
                return NotFound();
